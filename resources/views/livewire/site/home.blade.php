<div class="w-full">
    ...
    <section class="overflow-hidden flex w-full h-screen bg-gray-200 items-center justify-center p-8">
        <div class="text-center">
            <p>Conectando sua comunidade</p>
            <p>a eventos imperdíveis</p>
            <p>descubra o melhor que a nossa cidade tem a oferecer</p>
            <h1>com Eventech!</h1>
        </div>
    </section>
    <!-- Seção adicional, se necessário -->
    <section class="overflow-hidden flex w-full h-screen bg-gray-800 items-center justify-center p-8">
